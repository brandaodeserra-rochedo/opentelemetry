...
from opentelemetry.exporter.otlp.proto.grpc.metric_exporter import OTLPMetricExporter  # noqa
from opentelemetry.sdk.metrics.export import PeriodicExportingMetricReader

# Configura o exportador OTLP (envia para o OTel Collector)
otlp_exporter = OTLPMetricExporter(endpoint="http://localhost:4317", insecure=True)  # noqa
...
# Cria o meter
meter = metrics.get_meter("megapadb-app")

# Cria um contador simples
request_counter = meter.create_counter(
    name="mepgapadb_app_requests",
...
while True:
    value = random.randint(5, 10)  # valor aleatório entre 1 e 5
